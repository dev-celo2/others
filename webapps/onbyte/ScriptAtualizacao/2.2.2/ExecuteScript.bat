...
isql.exe -q -i "C:/Program Files (x86)/SistemaEscola/webapps/onbyte/ScriptAtualizacao/2.2.2/ScriptAtualizacao.txt" -u sysdba -p masterkey  "C:/Program Files (x86)/SistemaEscola/webapps/onbyte/Banco.fdb" -ch WIN1252
